...
public class PC1 {
    ...
    public static void Play() {
        try {
            ...
            pc1_deck = new Deck(new TurnedCard());
            pc1_deck.cardToDeck(new OtherCard(suit, convertValue(y)));
            cards.add(x);
            cards.add(y);
            Thread.sleep(1000);
            ...
            Thread.sleep(1000);
            System.out.println("Player 1 takes " + y + ".");
            Thread.sleep(1500);
            pc1_deck.ShowDeck();
    ...
    public static void Draw(){
        try {
            ...
            int suit = rn.nextInt(3) + 1;
            pc1_deck.cardToDeck(new OtherCard(suit, convertValue(c)));
            visible_card += c;
            cards.add(c);
            Thread.sleep(1000);
